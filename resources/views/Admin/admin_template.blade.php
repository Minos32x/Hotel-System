    ...
    <aside class="main-sidebar">
        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu" data-widget="tree">
                ...
                <li class="active"><a href="/admin/getManagers"><i class="fa fa-link"></i> <span>manage Managers</span></a>
                </li>
                <li><a href="/admin/getReceptionist"><i class="fa fa-link"></i> <span>manage Recepionists</span></a>
                </li>
