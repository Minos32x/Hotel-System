                ...
                <div class="panel-body">
                    <form class="form-horizontal" method="POST" action="/floors/{{$floor->id}}/update">
                        ...
                        <div class="form-group{{ $errors->has('floor_num') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="floor_num" type="text" class="form-control" name="floor_num" value="{{ $floor->floor_num }}" required>
                         ...
                         <div class="form-group{{ $errors->has('no_of_room') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="no_of_room" type="text" class="form-control" name="no_of_room" value="{{ $floor->no_of_room }}" required>
